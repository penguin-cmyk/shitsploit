...
#[allow(non_upper_case_globals)]
pub static character: Lazy<Mutex<usize>> = Lazy::new(|| Mutex::new(0));
#[allow(non_upper_case_globals)]
pub static humanoid: Lazy<Mutex<usize>> = Lazy::new(|| Mutex::new(0));
#[allow(non_upper_case_globals)]
pub static entry_loaded: Lazy<Mutex<bool>> = Lazy::new(|| Mutex::new(false));
